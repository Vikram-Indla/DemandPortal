  ...
  const mockPortfolioRisks: CompactRiskItem[] = [
    {
      ...
      type: 'feature',
      hierarchyBreadcrumb: 'Security Enhancement → Compliance & Audit',
      priority: 'high',
      progress: 65,
      endDate: '2025-12-15',
      isAtRisk: true,
    ...
    },
    {
      ...
      type: 'initiative',
      hierarchyBreadcrumb: 'Digital Transformation',
      priority: 'medium',
      progress: 33,
      endDate: '2026-01-30',
      isAtRisk: true,
    },
    {
      ...
      type: 'feature',
      hierarchyBreadcrumb: 'Digital Transformation → Data Analytics Platform',
      priority: 'high',
      progress: 56,
      endDate: '2025-12-10',
      isAtRisk: true,
